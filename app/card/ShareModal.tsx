...
export default function ShareModal({ isOpen, onClose }: ShareModalProps) {
  ...
  const [cardUrl, setCardUrl] = useState(''); // Initialize as empty string
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
      <div ref={modalRef} className="bg-[#1B2738] rounded-[24px] p-8 max-w-[420px] w-full shadow-[0_20px_50px_rgba(0,0,0,0.8)] text-white border border-[#2A3653]">
        <h2 className="text-[22px] font-bold mb-6">Share Joseph Iannazzi's Digital Business Card</h2>
        <div className="space-y-3">
          ...
          >
            <div className="flex items-center">
              <div className="w-[30px] h-[30px] flex items-center justify-center">
                <Image src="/images/personal.jpeg" alt="Link" width={24} height={24} className="rounded-full" />
              </div>
              <span className="ml-3">{copySuccess ? "Link Copied!" : "Copy Card Link"}</span>
            </div>
            <div className="flex items-center">
              <Image src="/landingpage/icons/copy.svg" alt="Copy" width={24} height={24} className="opacity-70" />
            </div>
          </div>
          ...
          >
            <div className="flex items-center">
              <div className="w-[30px] h-[30px] flex items-center justify-center">
                <Image src="/landingpage/icons/WhatsApp.svg" alt="WhatsApp" width={24} height={24} />
              </div>
