      ...
      <div className="bg-[#1B2738] rounded-[24px] p-8 max-w-[420px] w-full shadow-[0_20px_50px_rgba(0,0,0,0.8)] backdrop-blur-md relative border border-[#2A3653]">
        ...
        <div className="pl-1 mb-4">
          ...
          <p className="text-sm text-[#CBD5E1] leading-relaxed">
            Executive Assistant and Business Operations Specialist with 10+ years of experience streamlining HR, legal, onboarding, and compliance operations. Open to part-time, on-site, remote, or hybrid roles.
          </p>
        </div>
